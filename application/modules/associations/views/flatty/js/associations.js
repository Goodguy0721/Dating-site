...
function Associations(optionArr) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (!data.errors) {
                    ...
                    $('#' + _self.properties.btn_id).find('i').addClass('g');
                    $('#' + _self.properties.link_id).find('a').addClass('link-disabled');
    ...
    this.createAnswer = function (answer_gid) {
        ...
        html_data += '<div class="b-associations__item b-associations__item_right">' +
                ...
                '<div class="b-associations__name">' + _self.properties.profile.nickname + ', ' + _self.properties.profile.age + '</div>' +
