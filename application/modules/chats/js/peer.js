...
Negotiator.startConnection = function(connection, options) {
  ...
  //console.log('connection getPeerConnection pc: ', connection.pc);
  //console.log('getPeerConnection pc: ', pc);
  ...
  if (options.originator) {
    ...
    if (!util.supports.onnegotiationneeded) {
      ...
      setTimeout(function(ev){ Negotiator._makeOffer(connection); }, 1000);
    }
  } else {
...
Negotiator._startPeerConnection = function(connection) {
  ...
  // } else {
  //   connection.provider.options.config = {'iceServers': [{ 'urls': 'stun:23.21.150.121' }]};
  //   var pc = new mozRTCPeerConnection(connection.provider.options.config, optional);
  // }

  // console.log('Creating pc: ', pc);

  Negotiator.pcs[connection.type][connection.peer][id] = pc;

  // if(typeof (connection.pc) === 'undefined'){
  //   util.warn('pc undefined');
  //   return false;
  // }

  //console.log(pc);

  // for (var name in connection) {
  //   console.log(name + '\n');
  //   //console.warn(connection[name]);
  // }
