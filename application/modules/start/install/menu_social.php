...
return array(
    ...
    'user_top_menu' => array(
        ...
        "action" => "create",
        "items"  => array(
            'user-menu-homepage'      => array("action" => "create", 'icon' => 'square-o', 'link' => 'start', 'status' => 1, 'sorter' => 1),
            'user-menu-people'        => array("action" => "create", 'icon' => 'users', 'link' => '', 'status' => 1, 'sorter' => 2),
            'user-menu-communication' => array("action" => "create", 'icon' => 'retweet', 'link' => '', 'status' => 1, 'sorter' => 3),
            'user-menu-activities'    => array("action" => "create", 'icon' => 'bullhorn', 'link' => '', 'status' => 1, 'sorter' => 4),
        ),
    ),
