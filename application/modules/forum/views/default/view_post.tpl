...
<div class="content-block">
	...
	{if $post.can_comment eq '1'}
		<div style="margin-top:15px;">
			...
			<form action="" id="post_comment_form" method="POST" style="margin-top:15px;" class="hide">
				<div class="r">
					...
					<div class="v">
						...
						<script>{literal}
							...
							loadScripts(["{/literal}{$site_url}system/plugins/ckeditor/ckeditor.js{literal}"],
								function(){
									CKEDITOR.replace('body', {customConfig:'{/literal}{$site_url}system/plugins/ckeditor/config.js{literal}',language: 'ru', toolbar: 
										[
		...
		{foreach item=item from=$comments}
			...
			<div class="clr"></div>
			<form action="" id="post_comment_form_{$item.id}" class="hide" method="POST" style="margin-top:15px;">
				...
				<div class="r">
					...
					<div class="v">
						...
						<script>{literal}
							...
							loadScripts(["{/literal}{$site_url}system/plugins/ckeditor/ckeditor.js{literal}"],
								function(){
									CKEDITOR.replace('body{/literal}{$item.id}{literal}', {customConfig:'{/literal}{$site_url}system/plugins/ckeditor/config.js{literal}',language: 'ru', toolbar: 
										[
											{ name: 'document', items: [ 'Source' ] },
											{ name: 'actions', items: [ 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo' ] },
											{ name: 'links', items: [ 'Link', 'Unlink', 'Anchor' ] },
