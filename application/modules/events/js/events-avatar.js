function avatar(optionArr) {
    this.properties = {
        site_url: '',
        load_avatar_url: 'events/ajaxLoadAvatar/',
        photo_id: 'event_photo',
        id_event: 0,
        recrop_url: 'events/ajaxRecropAvatar/',
    ...
    this.load_avatar = function () {
        $.ajax({
            ...
            type: 'POST',
            data: {id_event: _self.properties.id_event},
            dataType: 'json',
            cache: false,
    ...
    this.recrop = function () {
        ...
        xhr_recrop = $.ajax({
            ...
            type: 'POST',
            data: {'selections': _self.selections[_self.index], 'event_id': _self.properties.id_event},
            dataType: 'json',
            cache: false,
            success: function (resp) {
                if (resp.status) {
