 ...
 * */
class Users_listnew_widget extends Model
{
    /**
     ...
     * @var string
     */
    private $gid = 'users_listnew_widget';
    ...
    private $langs_data = array(
        'en' => array(
            ...
            'users_listnew_widget_name'        => 'New users widget',
            'users_listnew_widget_description' => 'The widget displays new site users',
        ),
        'ru' => array(
            ...
            'users_listnew_widget_name'        => 'Виджет с новыми пользователями',
            'users_listnew_widget_description' => 'Виджет выводит фотографии новых пользователей сайта',
        ),
    );
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12"><input type="text" name="data[settings][count]" value="' . intval($data['count']) . '" class="form-control"></div>
  </div>
  ';
        } else {
            $return = '
