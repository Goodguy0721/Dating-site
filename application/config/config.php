...
if (file_exists(dirname(__FILE__) . '/langs_route.php')) {
    include dirname(__FILE__) . '/langs_route.php';
}
...
|
*/
$config['base_url']    = SITE_VIRTUAL_PATH;
...
|
*/
$config['cache_path'] = TEMPPATH . 'cache/';
...
|
*/
$config['encryption_key'] = 'secret_word';
...
$config['sess_expiration']            = 60 * 60 * 24 * 100;
$config['sess_encrypt_cookie']        = true;
$config['sess_use_database']        = true;
$config['sess_table_name']            = DB_PREFIX . 'sessions';
...
$config['sess_timeout']             = 0; //0 - in obsession
$config['sess_destroy_on_timeout']  = false;
$config['sess_update_interval']     = 180; //seconds
$config['sess_time_to_update']      = 60 * 60 * 24 * 10; //seconds
$config['sess_gc_probability']      = 40;
$config['sess_http_only']           = false; // PHP 5.2+ or better only!
$config['sess_forwarded_ip']        = false;
$config['sess_secure']              = false;

$config['api_table_name']            = DB_PREFIX . 'tokens';
...
$config['cookie_domain']    = COOKIE_SITE_SERVER;
$config['cookie_path']        = "/" . SITE_SUBFOLDER;
