...
class GIFEncoder
{
    ...
    */
    ...
    {
        $GIF_src = isset($params["GIF_src"]) ? $params["GIF_src"] : '';
        $GIF_dly = isset($params["GIF_dly"]) ? $params["GIF_dly"] : '';
        $GIF_lop = isset($params["GIF_lop"]) ? $params["GIF_lop"] : '';
        $GIF_dis = isset($params["GIF_dis"]) ? $params["GIF_dis"] : '';
        $GIF_red = isset($params["GIF_red"]) ? $params["GIF_red"] : '';
        $GIF_grn = isset($params["GIF_grn"]) ? $params["GIF_grn"] : '';
        $GIF_blu = isset($params["GIF_blu"]) ? $params["GIF_blu"] : '';
        $GIF_mod = isset($params["GIF_mod"]) ? $params["GIF_mod"] : '';
    ...
    */
    ...
    ::
    */
     public function GetAnimation($params)
     {
