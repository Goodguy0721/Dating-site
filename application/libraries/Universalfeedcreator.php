 ...
 *
 * @version   $Revision: 62 $ $Date: 2010-01-06 12:53:35 +0300 (Ð¡Ñ€, 06 ÑÐ½Ð² 2010) $ $Author: mmakeev $
 */
 ...
 * @since 1.3
 */
class FeedItem1 extends HtmlDescribable
{
    /**
...
class FeedCreator extends HtmlDescribable
{
    ...
    public function _createStylesheetReferences()
    {
        ...
        if (isset($this->xslStyleSheet) && $this->xslStyleSheet) {
...
class RSSCreator10 extends FeedCreator
{
    ...
    public function createFeed()
    {
        ...
        for ($i = 0;$i < count($this->items);++$i) {
            ...
            $feed .= "        <pubDate>" . date("r", strtotime($this->items[$i]->date)) . "</pubDate>\n";
