...
class QRrsblock
{
    ...
    class QRcode
    {
        ...
        //----------------------------------------------------------------------
        public static function png($text, $outfile = false, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint = false, $rgb_color = '0,0,0', $rgb_bg_color = '255,255,255')
        {
            $enc = QRencode::factory($level, $size, $margin);

            return $enc->encodePNG($text, $outfile, $saveandprint, $rgb_color, $rgb_bg_color);
        }
    ...
    class QRencode
    {
        ...
        //----------------------------------------------------------------------
        public function encodePNG($intext, $outfile = false, $saveandprint = false, $rgb_color = '0,0,0', $rgb_bg_color = '255,255,255')
        {
            try {
                ob_start();
                ...
                QRimage::png($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin, $saveandprint, $rgb_color, $rgb_bg_color);
            } catch (Exception $e) {
