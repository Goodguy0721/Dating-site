...
class CPDF_Adapter implements Canvas
{
  ...
  public function text($x, $y, $text, $font, $size, $color = array(0, 0, 0), $word_space = 0, $char_space = 0, $angle = 0)
  {
      $pdf = $this->_pdf;
   ...
   */
  public function page_text($x, $y, $text, $font, $size, $color = array(0, 0, 0), $adjust = 0, $angle = 0)
  {
      $_t = "text";
