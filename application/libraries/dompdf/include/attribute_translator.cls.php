...
//    ),
    ...
    public static function append_style(DOMNode $node, $new_style)
    {
        $style = rtrim($node->getAttribute(self::$_style_attr), ";");
        $style .= $new_style;
        $style = ltrim($style, ";");
    ...
    protected static function get_cell_list($node)
    {
  ...
  protected static function _get_valid_color($value)
  {
    ...
    protected static function _set_color($node, $value)
    {
    ...
    protected static function _set_background_color($node, $value)
    {
        $value = self::_get_valid_color($value);
    ...
    protected static function _set_hr_size($node, $value)
    {
        $style = rtrim($node->getAttribute(self::$_style_attr), ";");
