...
class Font_TrueType extends Font_Binary_Stream
{
  ...
  private static $raw = false;
    ...
    public static $nameIdCodes = array(
    0  => "Copyright",
    1  => "FontName",
    2  => "FontSubfamily",
    3  => "UniqueID",
 ...
 // 2 =>  Reserved
    ...
    public static $plaformSpecific = array(
    // Unicode
    0 => array(
      0 => "Default semantics",
  ...
  //  9 => Reserved
    ...
    public static $macCharNames = array(
    ".notdef", ".null", "CR",
    ...
    public function lookupGlyph($gid, &$gids, &$newGlyphOffsets, $glyfOffset, $indexToLoc, $gidToCid)
    {
    ...
    public function encode($tags = array())
    {
        if (!self::$raw) {
