...
class CI_Typography
{
    ...
    public $skip_elements    = 'p|pre|ol|ul|dl|object|table';

    // Tags we want the parser to completely ignore when splitting the string.
    public $inline_elements = 'a|abbr|acronym|b|bdo|br|button|cite|code|del|dfn|em|i|img|ins|input|label|map|kbd|samp|select|span|strong|sub|sup|textarea|var';
     ...
     * @return string
     */
    public function auto_typography($str, $strip_js_event_handlers = true, $reduce_linebreaks = false)
    {
        if ($str == '') {
            return '';
        }
