...
class CI_DB_mariadb_driver extends CI_DB
{
    ...
    /**
     * Whether to use the mariadb "delete hack" which allows the number
...
/* End of file mariadb_driver.php */
/* Location: ./system/database/drivers/mariadb/mariadb_driver.php */
